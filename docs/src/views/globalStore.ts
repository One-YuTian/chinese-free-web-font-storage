...
fetch(
    "https://cdn.jsdelivr.net/gh/One-YuTian/chinese-free-web-font-storage@latest/fonts.json"
)
    .then((res) => res.json())
    .then((res) => {
        fonts.push(...res);
...
export const useGlobalStore = defineStore("global", {
    state: () => {
        return {
            fonts,
            config: {
                root: "https://cdn.jsdelivr.net/gh/One-YuTian/chinese-free-web-font-storage@latest/build/",
